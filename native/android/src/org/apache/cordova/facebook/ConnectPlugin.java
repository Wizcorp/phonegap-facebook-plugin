...
public class ConnectPlugin extends Plugin {
	...
	// !!! RH
	public JSONObject getDynamicResponse(Bundle values) {
	...
	class UIDialogListener implements DialogListener {
		...
		public void onComplete(Bundle values) {
			...
			// !!! RH: Pass the result back as a JsonObject 
			this.fba.success(new PluginResult(PluginResult.Status.OK, getDynamicResponse(values)), this.fba.callbackId);			
		}
