...
This is the official plug-in for Facebook in Apache Cordova/PhoneGap!
...
To use this plug-in you will need to make sure you've registered your Facebook app with Facebook and have an `APP_ID` [https://developers.facebook.com/apps](https://developers.facebook.com/apps).
