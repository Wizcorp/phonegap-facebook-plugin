...
7. Add your application's Bundle ID and enable Facebook Login in the Native iOS App section of your Facebook application's settings on the [Facebook Developer Website](https://developers.facebook.com/apps).
